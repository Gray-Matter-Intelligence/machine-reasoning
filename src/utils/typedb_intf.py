# ISSUE: https://github.com/Gray-Matter-Intelligence/machine-reasoning/issues/9

# Taken from https://github.com/typedb/typedb-driver/blob/master/python/example.py
